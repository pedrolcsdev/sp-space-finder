...
export const categories: Category[] = [
  { id: "auditorium", name: "Auditórios", description: "Espaços amplos para eventos e apresentações", icon: "Presentation", count: 8 },
  { id: "dental", name: "Salas Odontológicas", description: "Consultórios equipados para profissionais", icon: "Stethoscope", count: 12 },
  { id: "meeting", name: "Salas de Reunião", description: "Ambientes modernos para reuniões corporativas", icon: "Users", count: 15 },
];
