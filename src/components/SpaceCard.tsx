  ...
  return (
    ...
    >
      <Link
        ...
        className="group block cursor-pointer overflow-hidden rounded-xl border border-border bg-card card-shadow transition-all duration-300 hover:-translate-y-0.5 hover:card-shadow-hover focus-visible:-translate-y-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/45 focus-visible:ring-offset-2 focus-visible:ring-offset-background focus-visible:card-shadow-hover"
      >
        {/* Image */}
        <div className="relative aspect-[16/10] overflow-hidden">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-foreground/35 to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100 group-focus-visible:opacity-100" />
            ...
            <div className="flex items-center justify-between border-t border-border pt-3">
              ...
              <span
                ...
                className={cn(
                  ...
                  "pointer-events-none h-9 rounded-md px-3.5 text-xs",
                )}
              >
                Ver detalhes
              </span>
