    ...
    return (
      <div className={cn("flex items-center gap-3", className)}>
        ...
        <div className={cn("leading-none", textClassName)}>
          <div className="pl-0.5 text-[0.62rem] font-light uppercase tracking-[0.7em] text-muted-foreground sm:text-xs">
            Grupo
          </div>
          <div className="mt-1 text-xl font-extralight uppercase tracking-[0.18em] text-foreground/80 sm:text-2xl">
            São Paulo
          </div>
        </div>
      </div>
  ...
  return (
    <div className={cn("flex flex-col items-center", className)}>
      ...
      <div className={cn("mt-2 text-center leading-none", textClassName)}>
        <div className="text-[0.62rem] font-light uppercase tracking-[0.9em] text-muted-foreground sm:text-xs">
          Grupo
        </div>
        <div className="mt-2 text-[1.75rem] font-extralight uppercase tracking-[0.26em] text-foreground/80 sm:text-[2.1rem]">
          São Paulo
        </div>
      </div>
    </div>
